...
export default function instruction(props: PageProps) {
    return (
        <>
            <div class=" px-6 pt-6 flex flex-col h-full w-full ">
                <ol class="relative border-s border-blue-500 dark:border-gray-700">
                    <li class="mb-10 ms-4">
                        <div class="absolute w-3 h-3 bg-red-400 rounded-full mt-1.5 -start-1.5 border border-solid border-red-600 dark:border-gray-900 dark:bg-gray-700"></div>
                    ...
                    <li class="mb-10 ms-4">
                        <div class="absolute w-3 h-3 bg-red-400 rounded-full mt-1.5 -start-1.5 border border-solid border-red-600 dark:border-gray-900 dark:bg-gray-700"></div>
                        <span class="hover:text-red-600 text-green-400 m-2 text-lg font-semibold  dark:text-white">STEP 2 :</span > <span class="text-lg font-semibold  me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3"> Click on the Above <span class="text-blue-600 dark:text-blue-500"> STEP 2 </span> and Create User</span>
